...
@dag("sync_vendors", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
def sync_vendors():
    # vendor data sync
    @task.python
    def sync():
...
@dag("sync_countries_and_states", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
...
@dag("sync_locations", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
def sync_locations():
    # locations data sync
    @task.python
    def sync():
...
@dag("sync_kits", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
def sync_kits():
    # kit data sync
    @task.python
    def sync():
...
@dag("sync_customers", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
def sync_customers():
    # customer data sync
    @task.python
    def sync():
...
@dag("sync_master_products", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
...
@dag("sync_marketplaces", schedule='0 1 * * 2', start_date=datetime(year=2024,month=1,day=1), tags=["easyecom", "weekly"])
