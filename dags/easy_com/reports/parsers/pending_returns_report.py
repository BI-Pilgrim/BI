...
class PendingReturnsReportParserAPI(EasyComApiConnector):
    def __init__(self):
        super().__init__()
        self.project_id = "shopify-pubsub-project"
        self.dataset_id = "easycom"
        self.name = "Pending Returns Report"
        self.table_name = "pending_returns_report"
        self.report_type = constants.ReportTypes.PENDING_RETURN_REPORT.value
