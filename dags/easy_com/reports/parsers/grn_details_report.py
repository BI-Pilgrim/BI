...
class GRNDetailsReportParserAPI(EasyComApiConnector):
    def __init__(self):
        super().__init__()
        self.project_id = "shopify-pubsub-project"
        self.dataset_id = "easycom"
        self.name = "GRN Details Report"
        self.table_name = "grn_details_report"
        self.report_type = constants.ReportTypes.GRN_DETAILS_REPORT.value
