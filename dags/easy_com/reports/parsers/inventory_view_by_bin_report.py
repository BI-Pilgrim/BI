...
class InventoryViewByBinReportParserAPI(EasyComApiConnector):
    def __init__(self):
        super().__init__()
        self.project_id = "shopify-pubsub-project"
        self.dataset_id = "easycom"
        self.name = "Inventory View By Bin Report"
        self.table_name = "inventory_view_by_bin_report"
        self.report_type = constants.ReportTypes.INVENTORY_VIEW_BY_BIN_REPORT.value
