...
class StatusWiseStockReportParserAPI(EasyComApiConnector):
    def __init__(self):
        super().__init__()
        self.project_id = "shopify-pubsub-project"
        self.dataset_id = "easycom"
        self.name = "Status wise stock Report"
        self.table_name = "status_wise_stock_report"
        self.report_type = constants.ReportTypes.STATUS_WISE_STOCK_REPORT.value
