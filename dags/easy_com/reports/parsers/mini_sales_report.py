...
class MiniSalesReportParserAPI(EasyComApiConnector):
    def __init__(self):
        super().__init__()
        self.project_id = "shopify-pubsub-project"
        self.dataset_id = "easycom"
        self.name = "Mini Sales Report"
        self.table_name = "mini_sales_report"
        self.report_type = constants.ReportTypes.MINI_SALES_REPORT.value
