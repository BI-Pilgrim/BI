...
target.COD_Excluding_Tax = source.COD_Excluding_Tax,
target.Shipping_Charge_Excluding_Tax = source.Shipping_Charge_Excluding_Tax,
target.Shipping_Discount_Excluding_Tax = source.Shipping_Discount_Excluding_Tax,
target.Promotion_Discount_Excluding_Tax = source.Promotion_Discount_Excluding_Tax,
target.Miscellaneous_Excluding_Tax = source.Miscellaneous_Excluding_Tax,
target.Gift_Wrap_Charges_Excluding_Tax = source.Gift_Wrap_Charges_Excluding_Tax,
target.Prepaid_Discount_Excluding_Tax = source.Prepaid_Discount_Excluding_Tax,
target.Promocode_Discount_Excluding_Tax = source.Promocode_Discount_Excluding_Tax,
