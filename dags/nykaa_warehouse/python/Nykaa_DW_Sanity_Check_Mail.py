...
def send_sanity_check_email():
    ...
    SELECT 
        *
    FROM 
        `shopify-pubsub-project.Data_Warehouse_Nykaa_Staging.Nykaa_sanity_check`
    ...
    subject = "Nykaa Staging Data Warehouse Descrepancy !!!"
    ...
    if not filtered_df.empty:
        ...
        body = "Hi Team,<br><br>No discrepancies found in the Nykaa data warehouse.<br><br>Warm Regards,"
