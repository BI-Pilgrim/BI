CREATE OR REPLACE TABLE `shopify-pubsub-project.Data_Warehouse_Amazon_ads.display_report_stream` 
...
reportDate
FROM (
  SELECT * FROM `shopify-pubsub-project.pilgrim_bi_airbyte_amazon_ads.sponsored_display_report_stream`
)
