...
def retrieve_jwt_token():
    ...
    data = {
        "email": "techaccounts@discoverpilgrim.com",
        "password": "Rayban1a@",
        "location_key": "en133102369"
    }
...
def upload_file_to_s3(file_content, bucket, object_name):
    s3_client = boto3.client(
        's3',
        aws_access_key_id='AKIAXADPTGZUECCWACMS',  
        aws_secret_access_key='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' 
    )
    try:
