...
source.ad_group_cpc_bid_micros,
source.ad_group_cpm_bid_micros,
source.ad_group_cpv_bid_micros,
source.ad_group_effective_target_cpa_micros,
source.ad_group_id,
source.ad_group_name,
source.segments_date,
source.ad_group_percent_cpc_bid_micros,
source.ad_group_target_cpa_micros,
source.ad_group_target_cpm_micros,
source.campaign_id,
source.metrics_cost_micros,
source.ad_group_targeting_setting_target_restrictions,
...
source.ad_group_campaign,
source.ad_group_display_custom_bid_dimension,
source.ad_group_effective_target_cpa_source,
source.ad_group_effective_target_roas_source,
source.ad_group_final_url_suffix,
source.ad_group_resource_name,
source.ad_group_status,
source.ad_group_type
)
