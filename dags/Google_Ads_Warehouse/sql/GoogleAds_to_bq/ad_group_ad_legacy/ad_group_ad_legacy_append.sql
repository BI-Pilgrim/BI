...
(
  ...
  REGEXP_EXTRACT(JSON_EXTRACT_SCALAR(ad_group_ad_ad_responsive_display_ad_marketing_images, '$[0]'),r'customers/\d+/assets/\d+') AS extracted_marketing_images,
  REGEXP_EXTRACT(JSON_EXTRACT_SCALAR(ad_group_ad_ad_responsive_display_ad_marketing_images, '$[0]'),r'customers/\d+/assets/\d+') AS extracted_sq_logo_images,
  FROM
  (
    SELECT
      *,
