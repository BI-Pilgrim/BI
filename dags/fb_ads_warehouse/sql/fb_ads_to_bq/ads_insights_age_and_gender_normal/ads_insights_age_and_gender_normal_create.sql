CREATE OR REPLACE TABLE `shopify-pubsub-project.Data_Warehouse_Facebook_Ads_Staging.ads_insights_age_and_gender_normal`
AS
SELECT
...
select
*,
row_number() over(partition by ad_id, date_start,gender,age order by _airbyte_extracted_at desc) as rn
