CREATE OR REPLACE TABLE `shopify-pubsub-project.Data_Warehouse_Facebook_Ads_Staging.ads_insights_delivery_device_normal`
...
select
*,
row_number() over(partition by ad_id,date_start,device_platform order by _airbyte_extracted_at) as rn
