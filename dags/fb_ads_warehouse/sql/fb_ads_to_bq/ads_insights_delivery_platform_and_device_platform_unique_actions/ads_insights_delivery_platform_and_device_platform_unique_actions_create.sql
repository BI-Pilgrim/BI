CREATE OR REPLACE TABLE `shopify-pubsub-project.Data_Warehouse_Facebook_Ads_Staging.ads_insights_delivery_platform_and_device_platform_unique_actions`
...
select
*,
row_number() over(partition by ad_id,date_start,publisher_platform,device_platform,JSON_EXTRACT_SCALAR(unique_acts, '$.action_type') order by _airbyte_extracted_at) as rn
