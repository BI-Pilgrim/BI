CREATE OR REPLACE TABLE `shopify-pubsub-project.Data_Warehouse_Facebook_Ads_Staging.ads_insights_dma_normal`
...
FROM
  shopify-pubsub-project.pilgrim_bi_airbyte_facebook.ads_insights_dma
