...
START_DATE = timezone.datetime(2024, 11, 07, 05, 30, 0, tzinfo=timezone.utc)  # Corresponds to 11 AM IST on 2024-11-7
...
with DAG(
    ...
    schedule_interval='30 05 * * *',  # Cron expression for 11 AM IST (11:30 PM UTC)
